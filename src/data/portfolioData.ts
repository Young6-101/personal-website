...
export const inspirationItems: InspirationItem[] = [
  {
    ...
    imageAlt: 'Inspiration - Games',
    gallery: [
      { src: '/images/game/2077.jpg', alt: 'Cyberpunk 2077' },
      { src: '/images/game/the witcher.jpg', alt: 'The witcher'},
      { src: '/images/game/assassin.jpg', alt: 'Assassin\'s creed'},
      { src: '/images/game/fallout4.jpg', alt: 'Fallout 4' },
      { src: '/images/game/tombraider.jpg', alt: 'Tomb Raider'},
      { src: '/images/game/devil.jpg', alt: 'Devil May Cry 5' },
  ...
  },
  {
    ...
    imageAlt: 'Inspiration - Books',
    gallery: [
      { src: '/images/book/annihilation.jpg', alt: 'Annihilation' },
      { src: '/images/book/sympathizer-book.jpg', alt: 'The Sympathizer' },
      { src: '/images/book/lordoftherings.jpg', alt: 'Lord of the Rings' },
      { src: '/images/book/the scar.jpg', alt: 'The Scar' },
      { src: '/images/book/White_Noise.jpg', alt: 'White Noise' },
    ],
  },
  {
    icon: '⚡',
    ...
    imageAlt: 'Inspiration - Movies',
    gallery: [
      { src: '/images/movie/arrival.jpg', alt: 'Arrival' },
      { src: '/images/movie/bladerunner.jpg', alt: 'Blade Runner' },
      { src: '/images/movie/sicario.jpg', alt: 'Sicario' },
      { src: '/images/movie/2049.jpg', alt: 'Blade Runner 2049' },
      { src: '/images/movie/matrix.jpg', alt: 'The Matrix' },
      { src: '/images/movie/socialnetwork.jpg', alt: 'The Social Network' },
      { src: '/images/movie/ghost in the shell.jpg', alt: 'Ghost in the shell'},
      { src: '/images/movie/sympathizer-serires.jpg', alt: 'The Sympathizer'},
      { src: '/images/movie/lotr.jpg', alt: 'Lord of the Rings'},
      { src: '/images/movie/ninjia.jpg', alt: 'Ninja Scroll'},
    ],
  },
  {
    icon: '♪',
    ...
    imageAlt: 'Inspiration - Music',
    gallery: [
      { src: '/images/music/1.jpg', alt: 'Album' },
      { src: '/images/music/2.jpg', alt: 'Album' },
      { src: '/images/music/3.jpg', alt: 'Album' },
      { src: '/images/music/4.jpg', alt: 'Album' },
      { src: '/images/music/5.jpg', alt: 'Album' },
      { src: '/images/music/6.jpg', alt: 'Album' },
      { src: '/images/music/7.jpg', alt: 'Album' },
      { src: '/images/music/8.jpg', alt: 'Album' },
      { src: '/images/music/9.jpg', alt: 'Album' },
      { src: '/images/music/10.jpg', alt: 'Album' },
      { src: '/images/music/11.jpg', alt: 'Album' },
      { src: '/images/music/12.jpg', alt: 'Album' },
      { src: '/images/music/13.jpg', alt: 'Album' },
      { src: '/images/music/14.jpg', alt: 'Album' },
      { src: '/images/music/15.jpg', alt: 'Album' },
      { src: '/images/music/16.jpg', alt: 'Album' },
      { src: '/images/music/17.jpg', alt: 'Album' },
      { src: '/images/music/18.jpg', alt: 'Album' },
      { src: '/images/music/19.jpg', alt: 'Album' },
      { src: '/images/music/20.jpg', alt: 'Album' },
      { src: '/images/music/21.jpg', alt: 'Album' },
      { src: '/images/music/22.jpg', alt: 'Album' },
      { src: '/images/music/23.jpg', alt: 'Album' },
      { src: '/images/music/24.jpg', alt: 'Album' },
      { src: '/images/music/25.jpg', alt: 'Album' },
    ],
  },
];
